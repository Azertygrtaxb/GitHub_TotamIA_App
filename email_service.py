...
from gmail_oauth import get_gmail_sender, create_message_with_attachment, send_gmail_message

logger = logging.getLogger(__name__)

def send_discount_email(email: str, discount_code: str, discount_percentage: int) -> bool:
    """
    Send only discount code to user's email using Gmail SMTP
    """
    try:
